...
export const NavTabsMenu = (props: PropsWithChildren<TabsProps>) => {
    ...
    return <div
        className="inline-flex flex-col sm:flex-row gap-4 text-lg border-l sm:border-l-0 sm:border-b border-gray-300">
